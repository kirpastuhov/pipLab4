...
/*
    ...
    Если ты не понял почему  нельзя создать экземпляр по старинке, то
    то так можно, НО это будет тупо, в некоторых сложных ситуациях DI оч классная штука (например если твой EJB синглтон,
